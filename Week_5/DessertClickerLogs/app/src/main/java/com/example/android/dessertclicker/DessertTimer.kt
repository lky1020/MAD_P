...
class DessertTimer(lifecycle: Lifecycle) : LifecycleObserver {
    ...
    // annotation indicates that the following method is watching for onStart lifecycle events
    ...
    // annotation indicates that the following method is watching for onStop lifecycle events
